  ...
  random_subject() {
    ...
    wx.request({
      url: 'http://127.0.0.1:8000/right_wrong/',  // 仅为示例，并非真实的接口地址
       data: {
        // sub_category: "Java",  //self.data.subject_type
        // sub_nums: "30"
       }, 
      header: {
      ...
      success(res) {
        ...
        for (var i = 0; i < res.data.length; i++) {
          console.log(res.data[i].subject)
          var subject = res.data[i].subject
          var title = subject.name
          var id = subject.id
          var option_a = subject.option_a
          var option_b = subject.option_b
          var option_c = subject.option_c
          var option_d = subject.option_d
